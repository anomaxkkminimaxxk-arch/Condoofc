    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 min-h-[80vh] flex flex-col items-center justify-center border-b border-primary/20 overflow-hidden bg-scanline">
        ...
        <div className="container relative z-10 px-4 flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-6 font-display tracking-widest uppercase">
            {settings?.hero_subtitle || "Exclusive Roblox Condo Games & Private Servers"}
          </p>
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            <div className="flex flex-col items-center">
              <span className="text-2xl font-display font-bold text-primary neon-text">+2.500</span>
              <span className="text-[10px] text-muted-foreground tracking-widest uppercase">Membros Verificados</span>
            </div>
            <div className="flex flex-col items-center border-x border-primary/20 px-8">
              <span className="text-2xl font-display font-bold text-primary neon-text">24/7</span>
              <span className="text-[10px] text-muted-foreground tracking-widest uppercase">Suporte Ativo</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-2xl font-display font-bold text-primary neon-text">100%</span>
              <span className="text-[10px] text-muted-foreground tracking-widest uppercase">Seguro & Privado</span>
            </div>
          </div>
